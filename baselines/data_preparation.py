...
def parse_args():
    ...
    parser.add_argument("-D", "--data-dir", default="/home/reindert/Valentin_REVO/DCASE_2024/dcase-few-shot-bioacoustic/baselines/dcase2024_task5")
...
class Feature_Extractor:
    ...
    def pcen(self, y):
        ...
        pcen = librosa.core.pcen(S=mel_spec, sr=self.sr)
    ...
    def extract_feature(self, audio_path):
        try:
            ...
            print('Error during feature extraction in file: ', audio_path)

        return result


def process(fpath, fe):
    print(fpath)
    error_files = []
...
def main(data_path: str):
    ...
    if not os.path.exists(PATH):
        breakpoint()
        print('Error could not find the files in the path: ', PATH)
